...
public class CourseInstructorTest {
    ...
    private void conflictTestHelper(boolean expectedResult, String t1, String t2, String d1, String d2, int m1, int m2){
        ...
        Assert.assertEquals("conflict should return " + expectedResult, expectedResult, c1.conflictsWith(c2));
        Assert.assertEquals("conflict should return " + expectedResult, expectedResult, c2.conflictsWith(c1));
    ...
    public void conflictTest(){
        ...
        conflictTestHelper(true, "05:00 PM", "04:59 PM", "MWF", "W", 1, 2);
        ...
        conflictTestHelper(true, "11:00 AM", "12:30 PM", "T", "T", 120, 1);
